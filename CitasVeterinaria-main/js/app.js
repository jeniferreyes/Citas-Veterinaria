...
// -------------------------------------ALERTA PARA ELIMINAR LA CITA------------------------------
            ...
            //darle funcion al boton de EliminarCita
...
const confirmacion = window.confirm('¿Estas seguro de que quieres eliminar la cita?')
...
bdark.addEventListener('click', e=>{
    body.classList.toogle('darkmode');
});
